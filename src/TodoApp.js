...
const GET_TASKS_API_BASE_URL = "http://get-tasks-api.chincholkar.shop";
const DELETE_TASK_API_BASE_URL = "http://delete-task-api.chincholkar.shop";
const CREATE_TASK_API_BASE_URL = "http://add-task-api.chincholkar.shop";
